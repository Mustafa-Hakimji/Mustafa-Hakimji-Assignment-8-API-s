...
var { getRestaurants, addRestaurant,getRestaurantByCity,getRestaurantById } = require('../controller/restaurantController');
...
router.get('/getRestaurantByCity', function(req, res, next) {
